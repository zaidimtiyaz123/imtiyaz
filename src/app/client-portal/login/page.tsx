...
export default function ClientPortalLoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      let user = null;
      if (data.email === DEMO_CREDENTIALS.client.email && data.password === DEMO_CREDENTIALS.client.password) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-heading font-bold text-gray-900 dark:text-white">Client Portal Login</h2>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Sign in to access your projects</p>
        </div>
          ...
          <CardContent>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 text-sm">
                <p className="font-medium text-gray-900 dark:text-white mb-2">Client:</p>
                <p className="text-gray-600 dark:text-gray-400 font-mono text-xs mb-1">client@example.com</p>
                <p className="text-gray-600 dark:text-gray-400 font-mono text-xs">client123</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400">
          <Link href="/admin/login" className="text-primary-600 dark:text-primary-400 hover:underline font-medium">
            Admin Login
          </Link>
        </p>
      </div>
