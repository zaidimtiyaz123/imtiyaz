...
import { 
  ...
  ArrowRight, Check, X, AlertTriangle, Shield, Zap, Menu, Mail
} from 'lucide-react';
      ...
      <aside className="fixed inset-y-0 left-0 z-40 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transform transition-transform duration-300 lg:translate-x-0 -translate-x-full" style={{ transform: mobileMenuOpen ? 'translateX(0)' : 'translateX(-100%)' }}>
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <a href="/" className="flex items-center gap-2 text-xl font-heading font-bold text-gray-900 dark:text-white">
      ...
      <Card variant="bordered" padding="lg">
        ...
        <CardContent className="space-y-6">
          ...
          <SettingGroup title="Integrations" fields={[
            { label: 'WhatsApp Business API Token', type: 'password', value: '••••••••••••••••' },
            { label: 'Razorpay Key ID', type: 'text', value: 'rzp_live_••••••••••••••••' },
            { label: 'Razorpay Key Secret', type: 'password', value: '••••••••••••••••••••••••••••••••' },
      ...
      >
        ...
        >
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onClose(); }}>
            ...
            />
            <div className="flex gap-3 pt-4">
              <Button type="submit" className="flex-1">{testimonial ? 'Update' : 'Add'}</Button>
              <Button type="button" variant="outline" onClick={onClose} className="flex-1">Cancel</Button>
            </div>
          </form>
        </motion.div>
